export default {
  hyperbeamEndpoint: import.meta.env.VITE_HYPERBEAM_ENDPOINT,
  gqlEndpoint: import.meta.env.VITE_GQL_ENDPOINT,
  primaryNestId: import.meta.env.VITE_PRIMARY_NEST_ID,
