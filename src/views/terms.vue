<template>
  <div class="container mx-auto px-4 py-8 max-w-4xl">
    <div class="prose prose-sm md:prose-base dark:prose-invert max-w-none">
      ...
      <p>
        Welcome to Wuzzy! By accessing or using our Arweave search platform ("Service"), you 
      ...
      <p>
        Wuzzy is a decentralized search platform that enables users to search and discover 
        content stored on the Arweave blockchain. Our Service provides:
      </p>
      <ul>
        <li>Multi-modal search (text, images, audio, video, and transaction data)</li>
        <li>Advanced query syntax with intelligent detection</li>
        <li>Integration with Arweave wallet for enhanced features</li>
        <li>Access to decentralized, permanent storage data</li>
      </ul>
      ...
      <ul>
        ...
        <li>Analytics requests: 20 requests per minute per IP (anonymized)</li>
      </ul>

      <h3>3.3 Wallet Connection</h3>
      <p>
        If you connect an Arweave wallet to the Service, you are responsible for:
      </p>
      <ul>
        <li>Maintaining the security of your wallet and private keys</li>
        <li>All transactions initiated from your wallet</li>
        <li>Ensuring your wallet software is legitimate and secure</li>
      </ul>
      <p>
        <strong>We never have access to your private keys or wallet funds.</strong>
      </p>
      ...
      <p>
        ...
        licensed under the <a href="https://www.gnu.org/licenses/agpl-3.0.en.html" target="_blank" rel="noopener noreferrer">GNU Affero General Public License v3.0 (AGPL-3.0)</a>. You may use, modify, and distribute 
        the code in accordance with the license terms.
      </p>

      <h3>4.2 Search Results</h3>
      <p>
        Search results are retrieved from the Arweave blockchain, a public, decentralized network. 
        We do not claim ownership of content indexed or displayed in search results. Content 
        ownership and licensing are determined by the original uploaders to Arweave.
      </p>

      <h3>4.3 User-Generated Content</h3>
      <p>
        When you upload content to Arweave (e.g., via integrated tools), you retain ownership 
        but grant Arweave a permanent, irrevocable license to store and distribute your content 
        as part of the blockchain. <strong>Content uploaded to Arweave cannot be deleted.</strong>
      </p>

      <h2>5. Privacy and Data Protection</h2>
      <p>
        Your privacy is important to us. Please review our 
        <router-link to="/privacy" class="underline">Privacy Policy</router-link> to understand 
        how we collect, use, and protect your information. Key points:
      </p>
      <ul>
        <li>No cookies or cross-site tracking</li>
        <li>Session data stored in your browser only</li>
        <li>Analytics tracking requires explicit consent</li>
      ...
      <p>
        Search results are retrieved from the Arweave blockchain and third-party indexing services. 
        We do not guarantee the accuracy, completeness, or legality of indexed content. Users 
        are responsible for verifying information independently.
      </p>
      ...
      <h3>6.4 Blockchain Risks</h3>
      <p>
        Arweave is a decentralized blockchain. We do not control the Arweave network and are 
        not responsible for:
      </p>
      <ul>
        <li>Network downtime or congestion</li>
        <li>Transaction fees or costs</li>
        <li>Loss of wallet access or funds</li>
        <li>Content permanence or availability on Arweave</li>
      </ul>
      ...
      <ul>
        ...
        <li>Content you upload to Arweave</li>
      </ul>
      ...
      <p>
        Wuzzy does not host content. We index and search content stored on the Arweave blockchain, 
        a decentralized network outside our control.
      </p>

      <h3>8.2 Reporting Illegal Content</h3>
      <p>
        If you discover illegal content in search results:
      </p>
      <ul>
        <li>We cannot remove content from Arweave (it is permanent and decentralized)</li>
        <li>We may delist specific results from our index if legally required</li>
        <li>Report concerns to: <a href="mailto:legal@wuzzy.io">legal@wuzzy.io</a></li>
      </ul>
      ...
      <ul>
        <li>Content is stored on Arweave, not our servers</li>
        <li>We may delist infringing content from our index upon valid DMCA notice</li>
        <li>Submit DMCA notices to: <a href="mailto:dmca@wuzzy.io">dmca@wuzzy.io</a></li>
      </ul>
      ...
      <p>
        ...
        We are not responsible for third-party service availability, security, or policies.
      </p>
      ...
      <p>
        These Terms are governed by the laws of the State of Wyoming, United States, without regard to conflict 
        of law principles.
      </p>
      ...
      <p>
        ...
        in class actions or collective proceedings.
      </p>

      <h2>13. Open Source and Contributions</h2>
      <p>
        Wuzzy is an open-source project. By contributing code, documentation, or feedback:
      </p>
      <ul>
      ...
      <ul>
        ...
        <li><a href="https://github.com/Memetic-Block" target="_blank" rel="noopener noreferrer">Memetic Block GitHub</a></li>
      </ul>
      ...
      <p>
        ...
        you and Wuzzy regarding the Service.
      </p>
      ...
      <ul>
        <li><strong>GitHub Issues:</strong> <a href="https://github.com/Memetic-Block/wuzzy-site/issues" target="_blank" rel="noopener noreferrer">Open an issue</a></li>
        <li><strong>Email:</strong> <a href="mailto:legal@wuzzy.io">legal@wuzzy.io</a></li>
        <li><strong>DMCA Notices:</strong> <a href="mailto:dmca@wuzzy.io">dmca@wuzzy.io</a></li>
      </ul>

      <hr class="my-8" />

      <p class="text-sm text-muted-foreground">
        By using Wuzzy, you acknowledge that you have read, understood, and agree to be bound 
